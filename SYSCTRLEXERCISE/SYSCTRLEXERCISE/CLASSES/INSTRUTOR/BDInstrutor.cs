    ...
    class BDInstrutor
    {
        ...
        ********************************************************************/
        public int Incluir(Instrutor pobj_Instrutor)
        {
            ...
            obj_Com.Parameters.AddWithValue("I_PER_CONVENIO", pobj_Instrutor.Per_Instrutor);
        ...
        public Instrutor FindByCod(Instrutor pobj_Instrutor)
        {
            ...
            try
            {
                ...
                if (obj_Dtr.HasRows)
                {
                    ...
                    pobj_Instrutor.Per_Instrutor = Convert.ToInt16(obj_Dtr["I_PER_CONVENIO"].ToString());
            ...
            try
            {
                ...
                if (obj_Dtr.HasRows)
                {
                    while (obj_Dtr.Read())
                    {
                        ...
                        obj_Instrutor.Per_Instrutor = Convert.ToInt16(obj_Dtr["I_PER_CONVENIO"].ToString());
